 ...
 *
 */
public class BHiveLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
	//~ Static fields/initializers =====================================================================================

	private static final Logger logger = LoggerFactory.getLogger(BHiveLoginUrlAuthenticationEntryPoint.class);
	...
	private final RedirectStrategy redirectStrategy = new BHiveRedirectStrategy();
